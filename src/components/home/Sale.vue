        ...
        <i class="el-icon-plus"></i>
			...
			<div class="content">
				<div class="item_fram">
                  ...
                  <div class="tag-head">
                    <div class="tag-box" :class="[TagName=='first'?'Tagactive':'']" @click="Changetag(1)">我的拍卖(5)</div>
                    <div class="tag-box" :class="[TagName=='second'?'Tagactive':'']" @click="Changetag(2)">我的关注(9)</div>
                  </div>
                  <div class="tag-content" v-show="TagName=='first'" id="mine" >
                    <div class="sale-img">
                      <img class="sale-image" src="../../assets/img/60.jpg" />
                    </div>
                    <div class="sale-info">
                      <div class="sale-name">
                        <span>作品名称:<span>《</span>丰收<span></span>》</span>
                      </div>
                      <div class="sale-company">
                        <span style="margin-left:-10px;">拍卖行:Diamond Mining Group</span>
                        <span style="margin-left:20px;">开拍时间:2021-02-01</span>
                      </div>
                    </div>
                    <div class="sale-page">
                    ...
                    <div class="sale-progress">
                        <div class="sale-time">
                          ...
                          <span style="margin-left:10px;">参观人数: 8</span>
                        </div>
